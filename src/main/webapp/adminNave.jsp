...
<nav class="nav-container">
	...
	<li><a href="show_inquiry_to_admin.jsp">View Inquiry</a></li>
	<li><a href="show_solution_to_admin.jsp">View Solution</a></li>
	<li><a href="Feedback_show_to_admin.jsp">View Feedback</a></li>
